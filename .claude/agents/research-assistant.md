...
tools: [Bash, Read, Write, Edit, Glob, Grep, LS, WebFetch, WebSearch, Skill, Agent, Workflow, AskUserQuestion, EnterPlanMode, ExitPlanMode, mcp__gitnexus__query, mcp__gitnexus__context, mcp__gitnexus__impact, mcp__gitnexus__cypher, mcp__alphaxiv__discover_papers, mcp__alphaxiv__get_paper_content, mcp__alphaxiv__answer_pdf_queries, mcp__alphaxiv__read_files_from_github_repository]
