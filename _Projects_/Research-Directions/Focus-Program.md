---
title: "Focus Program: The Explicit-Coupling Whole-Body Model"
aliases:
  - "Focus Program"
  - "Explicit-Coupling Program"
tags:
  - humanoid
  - embodied-AI
  - robotics
...
A closed, non-redundant loop — drop any one and the program has a hole:
...
|---|---|---|---|
| **1 — A1 falsifier** | M0–6 | explicit $\delta_{\text{base}}$ head vs implicit MoE on [[2604.07993\|HEX]]'s data; plot OOD-SR + balance recovery **vs reach aggressiveness** | go / no-go on the whole program |
