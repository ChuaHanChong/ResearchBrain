...
- **Deep-dive mining**: reads of [[02_Dataset-Benchmark-Environment#1. Cross-Embodiment Scale Datasets|02_Dataset-Benchmark-Environment §1]], [[02_Dataset-Benchmark-Environment#8. Bimanual & Humanoid Evaluation|02 §8]], [[11_Sim-to-Real-Transfer#3. Policy-Side: Robustness & Domain Randomization|11_Sim-to-Real-Transfer §3]]; the proprioceptive-vs-perceptive and world-model-for-adaptation threads seeded A1 (perceptive terrain), B1 (proprioceptive robustness), B2 (dreaming for adaptation).
