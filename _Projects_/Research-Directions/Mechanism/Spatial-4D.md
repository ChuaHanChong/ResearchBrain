...
| **Anchor papers** | [[2506.20134\|3D World Models Survey]], [[2510.16732\|World Models for Embodied AI Survey]], [[2604.22748\|Agentic World Modeling Survey]], [[2606.03943\|PointAction]], [[2508.09071\|GeoVLA]], [[2605.21414\|PointACT]] |
...
- [[2604.18484|XEmbodied]] — Geometric+physical-cue foundation model with a 3D Adapter; +8.44% embodied-affordance, 55.28% Ego3DBench; geometry-pretrained backbone the point head can inherit.
- [[2604.17880|ST-π]] — Structured spatio-temporal VLA with ST-VLM decomposition + dual-generator action expert; top SR across 4 LIBERO suites, gains widen on long-horizon; the structured-geometry action head.
- [[2605.11832|AML-VLA]] — Multi-view latent action manifold with G³T depth priors; 98.6% LIBERO, 85.7% LIBERO-Plus zero-shot perturbation; learned-3D-prior policy robust under shift.
...
| **Anchor papers** | [[2604.22748\|Agentic World Modeling Survey]], [[2510.16732\|World Models for Embodied AI Survey]], [[2506.20134\|3D World Models Survey]], [[2603.28887\|OccSim]], [[2510.10125\|CTRL-WORLD]] |
...
- [[2605.09196|RigidFormer]] — Transformer rigid-body dynamics forecaster; 0.161 m / 15.33° MOVi-B error, 23.9 FPS (8× FIGNet), stable to 217 objects; the geometric forward model occupancy planning needs.
- [[2506.23135|RoboScape]] — Physics-informed embodied WM (RGB + temporal depth + keypoint dynamics); policies on 200 synthetic trajectories hit 91% Robomimic, 0.953 Pearson real-SR; the forward-model-for-policy substrate.
...
| **Anchor papers** | [[2504.05786\|3D Spatial Reasoning in LLM Survey]], [[2506.20134\|3D World Models Survey]], [[2510.16732\|World Models for Embodied AI Survey]], [[2510.14836\|QDepth-VLA]], [[2508.09071\|GeoVLA]] |
...
- **Assumption being challenged**: The [[2508.09071|GeoVLA]] / [[2606.03943|PointAction]] position that real 3D-awareness needs a full parallel 3D branch and joint re-training. [[2510.14836|QDepth-VLA]] shows a *frozen-backbone* depth-token task captures much of the gain, so the cheap/expensive split is false.
...
- [[2605.30350|DynaFLIP]] — Tri-modal-dynamics-guided representation; highest-SR frozen backbone on MetaWorld/RLBench + best LIBERO mean with Diffusion Policy; geometry baked into the encoder, no inference 3D.
- [[2605.09963|Spatial Prediction SP]] — Spatial pretext tasks bolt onto MAE/MoCo/DINO; +8.0% ImageNet-1K, jigsaw 69.87%→90.24%, lower texture bias; the cheap spatial channel added at the SSL-backbone layer.
...
| **Anchor papers** | [[2504.05786\|3D Spatial Reasoning in LLM Survey]], [[2506.20134\|3D World Models Survey]], [[2604.22748\|Agentic World Modeling Survey]], [[2507.13362\|VLM Spatial Reasoning RL]], [[2501.10074\|SpatialCoT]], [[2601.13304\|CausalSpatial]] |
...
- [[2604.14144|SpatialEvo]] — Self-evolving spatial intelligence via a Deterministic Geometric Environment for physically-grounded RL labels; 54.7 avg (7B), 5.1-pt drop without DGE GT; structure-as-supervision, not scale.
- [[2604.26934|World2VLM]] — Distills a world model's imagination into the VLM (GRPO, no inference-time generation); +15.44–15.98 pp across 4 spatial benchmarks; the simulate-then-reason habit internalized.
- [[2605.06758|R3L]] — Reasons 3D layouts from relative spatial relations via invariant decomposition + consistent imagination; 0.0% collision/out-of-bound, 1.8× faster convergence; metric scene-graph construction grounded.
- [[2605.11367|3D-Belief]] — Embodied belief inference via generative 3D world modeling; BEV IoU 0.484 at 55% visibility, 59.17% sim / 55.56% real object-nav; geometry-grounded reasoning over occluded state.
- [[2604.24300|ReVSI]] — Rebuilt visual-spatial-intelligence eval with dummy-video stress tests; fine-tuned models catastrophically hallucinate absent objects; exposes shortcut-vs-genuine-metric-3D — the diagnostic B1's bet predicts.
...
| **Anchor papers** | [[2506.20134\|3D World Models Survey]], [[2504.05786\|3D Spatial Reasoning in LLM Survey]], [[2510.16732\|World Models for Embodied AI Survey]], [[2605.05126\|ConsisVLA-4D]], [[2508.07917\|MolmoAct]] |
...
- [[2602.09878|MVISTA-4D]] — View-consistent 4D WM (spherical camera embedding + deformable cross-view attention) with trajectory-level action inference; 72.6% RLBench, lower depth/Chamfer; the explicit-4D-consistency policy.
- [[2604.08532|SelfEvo]] — Self-improving 4D perception via self-distillation, no labels; −19.7% depth AbsRel, +20.1% AUC@30 camera on new domains; the consistency-as-self-supervision mechanism that holds 4D geometry coherent.
...
| **Anchor papers** | [[2510.16732\|World Models for Embodied AI Survey]], [[2604.22748\|Agentic World Modeling Survey]], [[2506.20134\|3D World Models Survey]], [[2603.28887\|OccSim]], [[2604.26694\|X-WAM]] |
...
| **Anchor papers** | [[2506.20134\|3D World Models Survey]], [[2510.16732\|World Models for Embodied AI Survey]], [[2604.22748\|Agentic World Modeling Survey]], [[2507.01099\|Geometry-aware 4D Robot Video]], [[2507.13347\|Pi3]] |
...
- [[2604.27106|RecGen]] — Reconstruction-by-generation recovers explicit shape + 6-DoF pose; 92.7% ADD-SB@0.1, +38.2 pp under occlusion vs SAM3D; the predicted-geometry → tracker-readable-pose pipeline C2 generalizes.
- [[2602.09878|MVISTA-4D]] — View-consistent RGB-D 4D prediction with cross-view geometric attention; lower Chamfer/depth error than baselines; the cross-view-consistent geometry C2 extracts pose from (B2 boundary).
...
| **Anchor papers** | [[2506.20134\|3D World Models Survey]], [[2510.16732\|World Models for Embodied AI Survey]], [[2604.26509\|3D Generation for Embodied AI Survey]], [[2604.26694\|X-WAM]], [[2503.18945\|Aether]], [[2506.01103\|DeepVerse]] |
...
| **Anchor papers** | [[2604.22748\|Agentic World Modeling Survey]], [[2504.21853\|Interactive Generative Video Survey]], [[2602.04411\|Self-evolving Embodied AI]], [[2603.17117\|MosaicMem]], [[2603.24576\|Chameleon (Episodic Memory)]], [[2605.10921\|RoboMemArena]] |
...
- [[2605.22814|Remember to be Curious]] — Persistent 3DGS world model + long-term episodic memory for 3D exploration; higher scene completeness on HM3D/Gibson, RGB-only at test; episodic-context + persistent-geometry combined (C4-Q2 in one system).
...
| **Thesis** | An embodied agent acts on *scene-level interaction-readiness* — geometric validity, physical parameterization, kinematic executability of a whole reconstructed environment — not on appearance. The reconstruction field optimizes visual fidelity (PSNR/FID) and assumes a higher-fidelity NeRF/3DGS scene is a better embodied asset. The bet: a pipeline that bakes physics + kinematics from a single video produces directly-usable interactive environments ([[2404.09833\|Video2Game]] single-video → interactive NeRF+mesh+physics at 100+ FPS), against the survey-named bottleneck that "simulation-readiness over visual fidelity" is the real blocker ([[2604.26509\|3D Generation for Embodied AI Survey]]). *Single-object* physical-asset generation is D2's territory.* |
| **Anchor papers** | [[2604.26509\|3D Generation for Embodied AI Survey]], [[2506.20134\|3D World Models Survey]], [[2510.16732\|World Models for Embodied AI Survey]], [[2404.09833\|Video2Game]], [[2605.26115\|TriSplat]], [[2506.06440\|Vid2Sim]] |
...
- [[2506.06440|Vid2Sim]] — Video reconstruction of appearance + geometry + physics for mesh-free *scene* simulation; reconstruction optimized for the simulator, not the renderer.
...
- [[2403.08321|ManiGaussian]] — 3DGS world model for manipulation; 3DGS scene reconstructions can carry dynamics for action, not just rendering.
- [[2003.08515|SAPIEN]] — Articulated-object sim; the kinematic-executability (URDF-style) reference D1's reconstructed scenes must hit.
...
**Related research papers.**
- [[2404.09833|Video2Game]] — Single-video → interactive physics-ready *scene* environment; the build-for-interaction target.
- [[2604.26509|3D Generation for Embodied AI Survey]] — Simulation-readiness taxonomy; the fidelity-vs-readiness mismatch.
- [[2403.08321|ManiGaussian]] — 3DGS world model for manipulation; dynamics-carrying scene reconstructions.
...
- [[2506.06440|Vid2Sim]] — Video → appearance + geometry + physics for mesh-free scene simulation; reconstruction targeting the simulator directly.
- [[2406.10788|Embodied Gaussians]] — Real-time correctable WM coupling 3DGS render + PBD particles in a predict-correct loop; 30 Hz on 3 cameras, lower tracking error; physics-coupled scene reconstruction an agent can act in.
...
|---|---|
| **Cluster** | D — Reconstruction for Embodied Perception |
| **Thesis** | The reusable unit of an interactive environment is the *object*, not the scene — and an object is only embodied-useful if it carries its own material, mass, and kinematic structure, not just a watertight mesh. The 3D-generation field treats geometry and physics as separable stages: generate appearance first, annotate physics later (or never), and assume deformable/articulated assets can be hand-authored. The bet: a generator that recovers per-object material + kinematics in one pass produces simulation-ready assets across rigid, deformable, *and* articulated categories where the geometry-first pipeline fails the survey-named deformable-asset gap ([[2605.21572\|PhysX-Omni]] kinematic score 0.92; [[2605.30347\|NeuROK]] Chamfer-L1 0.028, energy-conserving on unseen categories). |
| **Anchor papers** | [[2604.26509\|3D Generation for Embodied AI Survey]], [[2506.20134\|3D World Models Survey]], [[2605.21572\|PhysX-Omni]], [[2605.30347\|NeuROK]], [[2503.17973\|PhysTwin]], [[2311.12198\|PhysGaussian]] |
...
**Why it matters.** D1 builds a whole scene you can act in; but the scene's *reusable parts* are objects, and a fidelity-first object is a hollow prop — a watertight surface with no mass, friction, or joints. [[2604.26509|3D Generation for Embodied AI Survey]] names the sharpest version of the bottleneck at the object level: the "trade-off between geometric quality and physical validity" and "scarcity of physical annotations," with *deformable assets* called out as unsolved. The geometry-first habit is the cause: a generator that outputs a mesh and leaves physics to a downstream annotation step produces objects that look right and behave wrong. [[2605.21572|PhysX-Omni]] inverts the order — a unified generator that emits rigid, deformable, *and* articulated objects with physical attributes baked in, scoring kinematic 0.92 on PhysXVerse and deploying the assets straight into robotic policy learning. [[2605.30347|NeuROK]] generates 4D neural object kinematics that stay energy-conserving on *unseen* categories (Chamfer-L1 0.028, IoU 0.764) — the inverse-kinematics object whose dynamics are physically consistent by construction, not curve-fit. [[2503.17973|PhysTwin]] and [[2605.09538|PhysHanDI]] take the deformable case the survey names open: physics-informed reconstruction of a single deformable object (or a hand–object pair) into an interactive twin from video. The contribution: make *per-object physical parameterization* the generation target so the asset is simulation-ready the moment it exists — the object-scale complement to D1's scene-scale readiness. Hinton-taste read: the brain models objects as bundles of affordances (how they move, deform, resist), not as textured shells — a generator that recovers physics-with-geometry is the biologically-natural unit, and the one a policy can actually grasp.

**First-principles framing.**
- **First principle**: An object's embodied value is a *joint* (geometry, material, kinematics) — the physics is not a separable post-hoc label but a property the geometry must be generated *consistent with* (a mesh and its mass/friction/joints co-determine how it behaves under contact). Splitting them discards the consistency a single-pass generator could enforce.
- **Assumption being challenged**: The geometry-first 3D-generation convention (the NeRF/3DGS-then-annotate pipeline) that appearance can be generated independently and physics bolted on, and that deformable/articulated assets must be hand-authored. [[2605.21572|PhysX-Omni]] and [[2605.30347|NeuROK]] show a *unified* generator recovers material + kinematics in the same pass and generalizes to unseen categories — so the staged pipeline is a legacy of fidelity-only objectives.
...
**Evidence.**
- [[2605.21572|PhysX-Omni]] — Unified simulation-ready generation for rigid, deformable, *and* articulated objects + PhysX-Bench; kinematic score 0.9185 on PhysXVerse, absolute-scale error 2.79 (vs >298 baselines), assets deployed in robotic policy learning; the canonical one-pass physical-asset generator.
- [[2605.30347|NeuROK]] — Generative 4D neural object kinematics; Chamfer-L1 0.028, IoU 0.764, energy-conserving dynamics on unseen categories (83.33% realism / 81.43% action-alignment user-preference); physics-consistent-by-construction kinematics.
- [[2503.17973|PhysTwin]] — Physics-informed reconstruction of a deformable object into an interactive digital twin from video, real-time sim + robotic motion planning; the per-object deformable-twin baseline.
- [[2605.09538|PhysHanDI]] — Physics-based dense hand–deformable-object twin from sparse RGB-D; Hand Chamfer 7.57→7.17 mm, ~2×/>7× lower spring RRD than [[2503.17973|PhysTwin]]; the deformable-readiness case the survey names open.
- [[2311.12198|PhysGaussian]] — Physics-integrated Gaussian Splatting (continuum mechanics on Gaussians: elastic, plastic, fracture, granular); physical parameterization baked into the 3DGS object itself.
- [[2412.17804|GausSim]] — Continuum elastic simulator over Gaussian kernels; L2 1.85 vs 11.32 DreamGaussian4D, 95% fewer kernel-wise computations, 0.13 s/frame at 2.1 GB; real-time per-object elastic rollout.
- [[2406.04338|Physics3D]] — Learns physical properties of a 3DGS object from video diffusion (MLS-MPM viscoelastic, SDS); PSNR 14.72; material parameterization recovered with no annotation.

**Concrete research questions.**
1. **Q1 — Joint vs staged generation.** Generate the same object (a) geometry-first then annotate physics, and (b) jointly via a [[2605.21572|PhysX-Omni]]-style unified head. Measure per-criterion readiness ([[2604.26509|3D Generation for Embodied AI Survey]]'s four) and how often the staged pipeline fails the kinematic/material criterion the joint one passes.
2. **Q2 — Where does the deformable/articulated gap live?** Decompose readiness by object class (rigid / deformable / articulated). Is the joint-generation advantage near-zero on rigid props and concentrated on deformable + articulated objects, as the first principle predicts?
3. **Q3 — Energy-conservation as a generalization signal.** [[2605.30347|NeuROK]] stays energy-conserving on unseen categories. Does enforcing a physical-consistency constraint (energy, momentum, [[2412.17804|GausSim]]'s mass conservation) at generation time predict out-of-category readiness better than fidelity (PSNR/Chamfer) alone?
4. **Q4 — Generated-object → policy transfer.** Does a D2 physics-jointly-generated object, dropped into D1's reconstructed scene, let a policy trained in sim act correctly on it — and is per-object material fidelity (mass/friction) or kinematic structure the binding constraint for that transfer?

**Related research papers.**
- [[2605.21572|PhysX-Omni]] — Unified rigid/deformable/articulated physical generation + PhysX-Bench; the physical-parameterization + kinematic-readiness generator.
- [[2605.30347|NeuROK]] — Generative 4D neural object kinematics; energy-conserving on unseen categories; physics-consistent-by-construction.
- [[2503.17973|PhysTwin]] — Physics-informed deformable digital twin from video; the per-object deformable readiness case.
- [[2605.09538|PhysHanDI]] — Hand–deformable-object physics twin from sparse RGB-D; the contact-rich deformable readiness case.
- [[2311.12198|PhysGaussian]] — Physics-integrated Gaussians; baked per-object physical parameterization (elastic/plastic/fracture/granular).
- [[2412.17804|GausSim]] — Continuum elastic Gaussian simulator; real-time per-object elastic rollout with mass/momentum conservation.
- [[2406.04338|Physics3D]] — Per-object material parameterization learned from video diffusion, no annotation; the recover-physics-from-appearance variant.
- [[2604.26509|3D Generation for Embodied AI Survey]] — Names the geometry-vs-physics trade-off + deformable-asset gap; the direction's organizing frame.
- [[2003.08515|SAPIEN]] — Articulated-object sim; the kinematic-executability (URDF) reference a generated articulated object must hit.

**Benchmarks & metrics.**
- [[2605.21572|PhysX-Omni]] PhysX-Bench / PhysXVerse — kinematic score (0.92), material, affordance, absolute-scale error (2.79 vs >298); the per-object physical-readiness scorecard, not PSNR.
- Chamfer-L1 / IoU — [[2605.30347|NeuROK]] 0.028 / 0.764; the geometric-reconstruction-accuracy ground truth for generated kinematic objects.
- Deformable-twin error — [[2605.09538|PhysHanDI]] Hand Chamfer 7.17 mm + spring-RRD (~2×/>7× lower than [[2503.17973|PhysTwin]]); [[2412.17804|GausSim]] L2 1.85 vs 11.32; the deformable/elastic readiness metrics.

> [!warning] Risks
> - **Per-object readiness has no shared leaderboard across categories** — PhysX-Bench is rigid/articulated-leaning, PhysTwin/PhysHanDI are deformable-specific. → Mitigation: adopt [[2604.26509|3D Generation for Embodied AI Survey]]'s four criteria as the common scorecard (Q1) and report per-class (rigid/deformable/articulated) pass/fail, not one aggregate.
> - **Physical parameters from a single video / sparse RGB-D may be under-determined** (mass/friction unobservable from kinematics alone). → Mitigation: Q3's physical-consistency constraints (energy/momentum) regularize the under-determined parameters; bound the claim to where the constraint identifies them.
> - **Boundary blur with D1** if "object" and "scene" leak. → Mitigation: pin D2 to the *single-object* generation unit (Q2, Q4) and D1 to *whole-scene* environments; a D2 object *populating* a D1 scene is the intended composition (Q4), not an overlap.
...
| No benchmark scores *per-object* physical-asset generation uniformly across *rigid + deformable + articulated* classes — readiness metrics are class-siloed | D2 | [[2605.21572\|PhysX-Omni]] PhysX-Bench (kinematic 0.92) is rigid/articulated-leaning; [[2503.17973\|PhysTwin]]/[[2605.09538\|PhysHanDI]] are deformable-specific; [[2605.30347\|NeuROK]] reports Chamfer/IoU — none score all three classes on one readiness scorecard |
