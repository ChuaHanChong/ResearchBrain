...
**Evidence.**
- [[2604.11674|AffordSim]] — Best zero-shot real policy ([[2504.16054|π0.5]]) reaches 25% (24% averaged); affordance-demanding tasks degrade most (mug-hang ~10%, pour ~30%, place ~40%) even with 3DGS backgrounds — the diagnostic for appearance-DR's semantic ceiling.
...
- [[2604.11674|AffordSim]] — Affordance-aware data generator; trajectory-collection SR 98/79/64% (Easy/Medium/Hard) vs [AnyGrasp](https://arxiv.org/abs/2212.08333) 67/15/3%, near the Manual oracle; ~24%-average zero-shot real ceiling — affordance is generated but transfer plateaus.
...
- [[2603.13825|Explicit-WM Manipulation]] — Digital-twin construction ([Hunyuan3D](https://arxiv.org/abs/2501.12202) + [[2304.07193|DINOv2]] alignment) for zero-shot open-world manipulation; 75%+ on 6/9 tasks; semantic reasoning via VLM, not randomized in sim.
...
|---|---|
| **Cluster** | A — Forward Sim-to-Real |
| **Thesis** | Sim-to-real transfer — which the field operationalizes as transferring *actions* (a policy or its distilled student) — has the irreducible truth that physical laws hold identically in sim and real while action distributions do not, which breaks the assumption that the policy is the only transferable artifact, and I bet a PINN-estimated physics *reward signal* (e.g. ground-reaction force) transfers across *conditions* — footwear, terrain, payload — where action policies fail, matching [[2604.23702\|QuietWalk]]'s R²>0.98 GRF accuracy as a sensor-free reward holding the −7.17 dBA objective across all 4 footwear types and outdoor terrains the policy never trained on (cross-*embodiment* reward portability is the open extension, Q2). |
...
- **The bet**: A PINN-estimated physics reward (GRF, contact wrench) transfers and *generalizes* across *conditions* — footwear, terrain, payload — where action policies don't, matching [[2604.23702|QuietWalk]]'s R²>0.98 sensor-free GRF accuracy as a reward holding the −7.17 dBA objective across all four footwear types and outdoor terrains the policy never trained on. (Cross-*embodiment* portability — robot A's PINN as robot B's reward — is the speculative extension Q2 probes, with no existence proof yet: [[2604.23702|QuietWalk]] demonstrates only single-robot cross-condition transfer.)
...
- [[2603.15956|ExpertGen]] — DSRL refines a behavior prior, then distills to visuomotor; 90.5% [AutoMate](https://arxiv.org/abs/2407.08028) — action-distribution transfer, reward stays sparse/task-level.
...
- [[2603.04029|Self-Adapting RL]] — [[2301.04104|DreamerV3]] OOD detection via prediction residuals → online fine-tune; residual is an adaptation trigger, adjacent to a transferable physics signal.
...
- [[2602.23253|SPARR]] — Asymmetric real-world residual corrects base-policy actions; 95–100% [AutoMate](https://arxiv.org/abs/2407.08028); the residual implicitly absorbs gain/dynamics mismatch the base policy can't.
...
- [[2602.23253|SPARR]] — Sim base + real residual; 95–100% [AutoMate](https://arxiv.org/abs/2407.08028), 74.5% [NIST](https://www.nist.gov/el/intelligent-systems-division-73500/robotic-grasping-and-manipulation-assembly/assembly) transfer; residual absorbs gain mismatch.
...
**Benchmarks & metrics.**
- [AutoMate](https://arxiv.org/abs/2407.08028) (8–10 tasks via [[2602.23253|SPARR]] / [[2603.15956|ExpertGen]]) — Contact-rich insertion/assembly; 90.5–100% SR; the contact-task suite where gains most affect transfer.
...
| **Thesis** | The real-to-sim gap — which [[2512.19562\|REALM]] is the first to name as a distinct object — has the irreducible truth that forward sim-real correlation is upper-bounded by how faithfully reality was inverted into the simulator, which breaks the assumption that forward fidelity is the bottleneck, and I bet jointly optimizing photoreal 3DGS appearance *and* physical parameters raises push-T sim-real correlation from [[2511.04831\|Isaac Lab]]'s r=0.649 to r>0.9 ([[2511.04665\|Real-to-Sim GS]] reaches r=0.915 on push-T, 0.901 on soft-body rope vs [[2511.04831\|Isaac Lab]] 0.237), matching it where appearance-only or physics-only reconstruction cannot. |
...
- **Assumption being challenged**: That forward fidelity (better physics engines, better DR) is the bottleneck. The simulator-engineering orthodoxy invests in forward realism, but [[2511.04665|Real-to-Sim GS]]'s 0.649→0.915 jump (push-T) and 0.237→0.901 jump (soft-body rope) from *inversion* (joint appearance+physics recovery), not a better engine, shows the binding constraint is reconstruction — and the gap to [[2511.04831|Isaac Lab]] is widest on deformables.
- **The bet**: Jointly optimizing photoreal 3DGS appearance and physical parameters raises sim-real correlation from r=0.649 ([[2511.04831|Isaac Lab]] on push-T) to r>0.9 — reproducing [[2511.04665|Real-to-Sim GS]]'s r=0.915 on push-T and r=0.901 on soft-body rope (vs [[2511.04831|Isaac Lab]] 0.237) — and the ablation will show appearance-only or physics-only inversion cannot reach it, confirming the gap is *joint*-reconstruction-bound.

**Evidence.**
- [[2511.04665|Real-to-Sim GS]] — Joint 3DGS + [[2503.17973|PhysTwin]] soft-body optimization; r=0.915 vs [[2511.04831|Isaac Lab]] r=0.649 (T-block); ablation: removing color *or* physics alignment collapses correlation — the joint-inversion proof.
- [[2512.19562|REALM]] — First to name the real-to-sim gap; [[2403.12945|DROID]]-aligned sysID, 7 skills/10 scenes/3,500+ objects/15 perturbations, r=0.92 overall across 5 perturbations (r=0.88 no-perturbation default); unseen objects cause largest drops.
...
- [[2512.19562|REALM]] — Names the real-to-sim gap; r=0.92 overall (5 perturbations) / r=0.88 no-perturbation default, 15 perturbations; [[2410.24164|π0]]/[π0-FAST](https://arxiv.org/abs/2501.09747)/[GR00T-N1.5](https://huggingface.co/nvidia/GR00T-N1.5-3B) degrade most on unseen objects.
...
- [[2504.03597|Real-is-Sim]] — Dynamic digital twin ([Embodied Gaussians](https://arxiv.org/abs/2406.10788)) corrected at 60 Hz by real RGB; 57%→80%, 82% best PushT; continuous real→sim correction.
- [[2603.13825|Explicit-WM Manipulation]] — Twin construction via [Hunyuan3D](https://arxiv.org/abs/2501.12202) + two-stage [[2304.07193|DINOv2]]/ICP alignment; 90.91% mug-free vs 27.27% direct alignment — alignment fidelity gates SR.
...
**Benchmarks & metrics.**
- [[2511.04665|Real-to-Sim GS]] — Sim-real r=0.915 (push-T) / 0.901 (soft-body rope) vs [[2511.04831|Isaac Lab]] 0.649 / 0.237; the headline gap the direction targets.
...
|---|---|
| **Cluster** | B — Real-to-Sim-to-Real |
| **Thesis** | Digital twins — which the field uses as evaluation sandboxes — have the irreducible truth that a grounded twin's highest-value output is *training data*, not a test environment, which breaks the assumption that twins are for evaluation, and I bet a closed real→sim→real co-training loop (abundant twin data + few real demos) beats both pure-forward-sim and pure-twin training on unseen-object generalization, matching [[2605.26638\|HyperSim]]'s 75%→95% and [[2403.03949\|RialTo]]'s 90%-vs-10% twin-specific advantage. |
...
|---|---|
| **Cluster** | B — Real-to-Sim-to-Real |
| **Thesis** | Real-to-sim dynamics recovery — which the field does by fitting the *parameters* of a hand-chosen constitutive law — has the irreducible truth that a hand-chosen law caps generalization at the expressiveness of its functional form, which breaks B2's assumption that recovering point parameters is enough, and I bet learning the constitutive *law* end-to-end inside a differentiable simulator generalizes to unseen geometries up to 1M particles where parameter-only sysID fails, matching [[2304.14369\|NCLaw]]'s <1e-3 reconstruction loss from real 2D video while feeding [[2503.17973\|PhysTwin]]/[[2511.04665\|Real-to-Sim GS]] a *generalizable* dynamics model rather than a per-object fit. |
| **Anchor surveys** | [[2604.26509\|3D Generation for Embodied AI Survey]], [[2604.04974\|Video-to-Control Survey]], [[2605.00080\|WM Robot Learning Survey]] |
...
- [[2511.04665|Real-to-Sim GS]] — Sim-real r=0.915 (push-T) / 0.901 (soft-body rope) vs [[2511.04831|Isaac Lab]] 0.649 / 0.237; the forward-correlation substrate a generalizable law must preserve across materials.
...
- [[2409.16578|FLaRe]] — Large-scale RL fine-tuning of a pre-trained BC policy; 80.7% real [Stretch RE-1](https://hello-robot.com/) (+30.7%), 79.5% sim (+23.6%), 72% [LoCoBot](http://www.locobot.org/) embodiment transfer (6 h for new-behavior adaptation) — deploy-time adaptation beating a frozen policy.
...
- [[2603.04029|Self-Adapting RL]] — [[2301.04104|DreamerV3]] OOD detection via prediction residuals → online fine-tune; the residual-trigger primitive a latent-extrinsics loop can gate on.
...
- [[2409.16578|FLaRe]] — RL fine-tuning to masterful real policies; +30.7% real, 72% [LoCoBot](http://www.locobot.org/) embodiment transfer (6 h new-behavior adaptation); deploy-time adaptation in manipulation.
...
- [[2409.16578|FLaRe]] — Real [Stretch RE-1](https://hello-robot.com/) 80.7% (+30.7%), sim 79.5% (+23.6%); the manipulation deploy-time-adaptation headline.
...
- **Assumption being challenged**: That online test-time adaptation is inherently slow. The online-RL-fine-tune orthodoxy ([[2603.04029|Self-Adapting RL]]'s [[2301.04104|DreamerV3]] loop) treats adaptation as re-learning — but [[2508.21065|Learning on the Fly]]'s 3-step / 4.5-s correction shows BPTT through a hybrid analytical+residual model collapses adaptation into a handful of gradient steps.
- **The bet**: Differentiable-sim TTA corrects OOD disturbance in ≤3 steps / 4.5 s with 81% hover-error reduction (vs L1-MPC) — beating [[2603.04029|Self-Adapting RL]]'s ~minutes-scale [[2301.04104|DreamerV3]] online fine-tune at equal deployment risk, with the speedup coming from first-order BPTT rather than sampled rollouts.

**Evidence.**
- [[2508.21065|Learning on the Fly]] — Hybrid analytical+residual differentiable dynamics; BPTT policy gradients; 81% hover-error reduction vs L1-MPC, 55% vs [DATT](https://arxiv.org/abs/2310.09053), improvement in 3 steps / 4.5 s; real quadrotor mass+wind — the differentiable-TTA existence proof.
- [[2603.04029|Self-Adapting RL]] — [[2301.04104|DreamerV3]] prediction-residual OOD detection → online fine-tune; the model-based-RL adaptation baseline differentiable TTA must beat on latency.
...
**Benchmarks & metrics.**
- [[2508.21065|Learning on the Fly]] — 81% hover-error reduction vs L1-MPC, 55% vs [DATT](https://arxiv.org/abs/2310.09053) under large OOD disturbance; 3 steps / 4.5 s adaptation — the speed+accuracy target.
...
- **The bet**: A world-model-supervised loop drives 4 Hz real-robot online adaptation to unseen dynamics with no real reward — holding [[2602.20057|AdaWorldPolicy]]'s 0.96 [[2306.03310|LIBERO]]-10 under OOD where a static policy degrades, with the recovery driven by prediction-error supervision rather than environment reward.

**Evidence.**
- [[2602.20057|AdaWorldPolicy]] — World model + action expert + force predictor (flow-matching DiT); online-adaptive-learning via prediction-error self-supervision, 4 Hz real-robot LoRA updates; 0.96 [[2306.03310|LIBERO]]-10, 48.0% [[2112.03227|CALVIN]] 5-task, OOD recovery — the prediction-error-supervised existence proof.
...
**Why it matters.** When a sim-trained imitation-learning policy hits the residual gap, it produces compounding errors and OOD actions — and the field's usual safety mechanisms are *soft*: penalty terms or probabilistic constraints that bound risk in expectation but not absolutely. [[2409.19190|RAIL]] makes safety a *hard* guarantee: a continuous-time reachability filter verifies whether the IL policy's proposed plan is collision-free (computing the robot's forward occupancy), and if not, a model-based backup planner executes a guaranteed-safe alternative. The numbers are unambiguous — 0% collision rate across all tasks vs 5–35% for baseline IL (on Pick-Place, [[2409.19190|RAIL]]+DP 0% vs [[2303.04137|Diffusion Policy]] 27.2% collisions), at a ~10-pp success cost (68% vs 78% SR) to eliminate *all* collisions, and on a real [Franka](https://franka.de/) arm [[2409.19190|RAIL]] solves the task safely while the vanilla diffusion policy fails the safety specification, running in real time at 0.42 s per plan. Counterintuitively, the hard constraint sometimes *raises* SR for weaker policies by steering them off doomed trajectories ([[2409.19190|RAIL]] lifts SSucc by up to +16 pp on low-performing seeds). This is the execution-time face of E1's adaptation-time safety: where E1 bounds the *update*, E2 bounds the *action*. [[2604.04974|Video-to-Control Survey]] names "physical feasibility" and "loop closure" as integration-layer gaps; a reachability shield supplies physical feasibility as a runtime guarantee under exactly the residual the sim-to-real gap leaves open.
...
- **The bet**: A reachability shield drives collision rate to 0% (vs 5–35% unshielded; [[2409.19190|RAIL]]+DP 0% vs [[2303.04137|Diffusion Policy]] 27.2% on Pick-Place) at a ~10-pp SR cost (68% vs 78%) — a hard guarantee under the residual gap that no soft penalty matches, and on weaker policies the filter can *raise* SR (up to +16 pp SSucc) by pruning doomed trajectories.

**Evidence.**
- [[2409.19190|RAIL]] — Continuous-time reachability safety filter + model-based backup planner over an IL policy; 0% collisions (vs 5–35% IL; [[2409.19190|RAIL]]+DP 0% vs [[2303.04137|Diffusion Policy]] 27.2% on Pick-Place at 68% vs 78% SR — Table III, Can Pick-Place), real-time at 0.42 s/plan on a real [Franka](https://franka.de/) — the reachability-shield existence proof.
...
**Benchmarks & metrics.**
- [[2409.19190|RAIL]] — 0% collision rate (vs 5–35% IL; Pick-Place [[2409.19190|RAIL]]+DP 68% SR / 0% collisions vs [[2303.04137|Diffusion Policy]] 78% / 27.2%), 0.42 s/plan real-time on a real [Franka](https://franka.de/) — the hard-guarantee headline.
