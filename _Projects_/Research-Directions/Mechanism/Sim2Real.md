...
| **Anchor papers** | [[2604.11674\|AffordSim]], [[2604.25459\|GS-Playground]], [[2605.26638\|HyperSim]], [[2604.26509\|3D Generation for Embodied AI Survey]], [[2601.07823\|Video Generation in Robotics Survey]], [[2507.10087\|Foundation Robotics Review]] |
...
**Benchmarks & metrics.**
- [[2604.11674|AffordSim]] — 50-task affordance data-collection benchmark (per-tier collection SR 79%/64% medium/hard); the 20-task simulation benchmark is where policies score ~24%-average zero-shot real (best 25%, mug-hang ~10%) — the ceiling to break.
...
| **Anchor papers** | [[2604.23702\|QuietWalk]], [[2601.07823\|Video Generation in Robotics Survey]], [[2507.10087\|Foundation Robotics Review]], [[2605.00080\|WM Robot Learning Survey]] |
...
| **Anchor papers** | [[2604.02523\|Tune to Learn]], [[2602.23253\|SPARR]], [[2605.00080\|WM Robot Learning Survey]], [[2604.04974\|Video-to-Control Survey]], [[2507.10087\|Foundation Robotics Review]] |
...
- [[2606.06218|TAM (Torque Adaptation)]] — Policy-agnostic torque-residual module (multi-robot pretrain → per-robot fine-tune, 1 kHz Torque Adaptor); real Franka pushing 47.6%→76.2%, zero-shot to Google Robot (1.05° vs 4.69°); the actuation-residual absorbing gain mismatch.
...
| **Anchor papers** | [[2511.04665\|Real-to-Sim GS]], [[2512.19562\|REALM]], [[2503.17973\|PhysTwin]], [[2604.26509\|3D Generation for Embodied AI Survey]], [[2604.04974\|Video-to-Control Survey]], [[2605.00080\|WM Robot Learning Survey]] |
...
- [[2512.14696|CRISP]] — Real-to-sim from monocular human-scene-interaction video (planar-primitive fitting + contact-guided completion + RL validity check); 93.1% real-to-sim vs VideoMimic 44.8% at 23K FPS; the video-to-asset inversion route.
...
| **Anchor papers** | [[2604.27367\|DOT-Sim]], [[2510.11689\|Phys2Real]], [[2503.17973\|PhysTwin]], [[2604.04974\|Video-to-Control Survey]], [[2605.00080\|WM Robot Learning Survey]], [[2604.26509\|3D Generation for Embodied AI Survey]] |
...
- [[2506.10133|Offline Domain Randomization]] — Formalizes DR as maximum-likelihood estimation of a sim-parameter distribution from offline data, with weak/strong consistency proofs + α-informativeness; the statistical case for *learning* the randomization, not hand-setting it.
...
| **Anchor papers** | [[2403.03949\|RialTo]], [[2605.26638\|HyperSim]], [[2504.03597\|Real-is-Sim]], [[2605.00080\|WM Robot Learning Survey]], [[2604.26509\|3D Generation for Embodied AI Survey]], [[2604.04974\|Video-to-Control Survey]] |
...
- [[2509.18631|Sim-Real OT Co-Training]] — Generalist co-training from abundant sim + sparse real via unbalanced optimal transport aligning the joint obs-action distribution; 0.73 image / 0.77 point-cloud real SR, generalizes to textures unseen in real demos; the distribution-alignment co-train.
...
| **Anchor papers** | [[2304.14369\|NCLaw]], [[2503.17973\|PhysTwin]], [[2604.27367\|DOT-Sim]], [[2604.26509\|3D Generation for Embodied AI Survey]], [[2604.04974\|Video-to-Control Survey]], [[2605.00080\|WM Robot Learning Survey]] |
...
> [!warning] Risks
> - **Single-anchor bet** — the learn-the-law case currently rests on one existence proof, [[2304.14369|NCLaw]], and NCLaw demonstrates *generalizable law recovery from video*, not a closed sim2real loop on a robot. A second existence proof showing a learned law surviving the full real→sim→real loop is still missing — so this direction is the most speculative in Cluster B, consistent with A2's "no existence proof yet" hedge on cross-embodiment reward transfer. → Treat the 1M-particle generalization as transfer-of-recovery evidence, not yet sim2real-loop evidence; Q2 (learned law into [[2511.04665|Real-to-Sim GS]]'s loop) is the go/no-go that would supply the missing proof.
...
| **Anchor papers** | [[2402.08191\|THE COLOSSEUM]], [[2405.05941\|SIMPLER]], [[2604.24018\|Sim2Real Betting]], [[2604.04974\|Video-to-Control Survey]], [[2605.00080\|WM Robot Learning Survey]], [[2502.10694\|UDA Simulation Study]] |
...
- [[2501.16389|Sim2Real Encoder Eval]] — Offline transfer diagnostic scoring which pretrained encoder will cross the gap (Domain Invariance Score + Action Score); manipulation-pretrained encoders top both; a per-component validity check predicting transfer before training.
...
| **Anchor papers** | [[2604.24018\|Sim2Real Betting]], [[2510.04354\|SureSim]], [[2605.00080\|WM Robot Learning Survey]], [[2502.10694\|UDA Simulation Study]], [[2604.04974\|Video-to-Control Survey]] |
...
| **Anchor papers** | [[2107.04034\|RMA]], [[2409.16578\|FLaRe]], [[2606.02280\|LDG]], [[2507.10087\|Foundation Robotics Review]], [[2605.00080\|WM Robot Learning Survey]], [[2604.04974\|Video-to-Control Survey]] |
...
- [[2212.07740|TERT]] — Terrain Transformer: a GPT-like student predicting teacher actions from proprioceptive history directly, *no* latent-vector estimation; real Unitree A1 100% sand / 60% stairs where the RMA/TCN baseline scores 0%; the history-to-action alternative to RMA's explicit extrinsics.
...
|---|---|
| **Cluster** | D — Deployment-Time Adaptation |
| **Thesis** | Online policy correction under unseen dynamics stalls because real reward is unavailable at deploy-time. But a world model's *prediction error* is a self-supervised reward surrogate — no environment reward needed — so the field's assumption that online correction requires a reward signal is wrong. This direction owns the regime where only a *learned* world model exists — its prediction error is the adaptation signal — which is exactly where D2's exact-gradient differentiable simulation does not apply because no analytical model is available. The bet: a world-model-supervised loop drives 4 Hz real-robot online adaptation to unseen dynamics with no real reward, holding [[2602.20057\|AdaWorldPolicy]]'s 0.96 [[2306.03310\|LIBERO]]-10 under OOD where a static policy degrades. |
| **Anchor papers** | [[2602.20057\|AdaWorldPolicy]], [[2603.04029\|Self-Adapting RL]], [[2605.00080\|WM Robot Learning Survey]], [[2604.04974\|Video-to-Control Survey]], [[2601.07823\|Video Generation in Robotics Survey]] |
...
**Why it matters.** The blocker on deploy-time correction: *real reward is not available* — you cannot run RL on hardware against a reward you can't compute. [[2602.20057|AdaWorldPolicy]] resolves it by making the world model an *active supervisor* — it unifies a world model, an action expert, and a force predictor under a flow-matching DiT, and uses the world model's *prediction error* as a self-supervised signal to drive test-time LoRA updates, at 4 Hz on real robots, with no environment reward. The result holds 0.96 on [[2306.03310|LIBERO]]-10 and recovers under visual and physical OOD where an offline-only policy degrades. This is the deploy-time face of B3's twin-as-data-engine and D2's differentiable TTA, and the fork between them is the model on hand: D2 owns the regime where an *analytical* model exists and the gradient is exact via differentiable simulation; D3 owns the regime where only a *learned* world model is available, so its prediction error — the mismatch between predicted and observed next-state — is itself the adaptation signal, supplying the gradient a privileged-extrinsics estimator (D1) or an analytical differentiable model (D2) cannot. [[2605.00080|WM Robot Learning Survey]] frames it: world models as evaluators whose value is "utility for action and physical consistency." A prediction-error-supervised loop turns physical consistency into a deploy-time reward.
...
| **Anchor papers** | [[2503.10949\|SCDA]], [[2409.19190\|RAIL]], [[2507.10087\|Foundation Robotics Review]], [[2502.10694\|UDA Simulation Study]], [[2605.00080\|WM Robot Learning Survey]] |
...
- [[2509.18648|SPiDR]] — Zero-shot *safe* sim-to-real: DR + a pessimistic cost penalty from a dynamics-model ensemble approximating the L1-Wasserstein gap, solved as a CMDP; transfers safely to a real race car + Go1 where vanilla DR violates constraints; safety at transfer-time, complementing SCDA's continual safe adaptation.
...
| **Anchor papers** | [[2409.19190\|RAIL]], [[2506.09937\|SAFE]], [[2604.04974\|Video-to-Control Survey]], [[2507.10087\|Foundation Robotics Review]], [[2605.00080\|WM Robot Learning Survey]] |
...
| **Anchor papers** | [[2506.09937\|SAFE]], [[2503.08558\|FAIL-Detect]], [[2604.04974\|Video-to-Control Survey]], [[2605.00080\|WM Robot Learning Survey]], [[2502.10694\|UDA Simulation Study]] |
...
- [[2605.30834|Hide-and-Seek]] — Step-level failure localization from internal action embeddings (LSTM + contrastive losses) with trajectory-only labels + conformal alarms; 0.852 bACC on LIBERO-10 seen, +11.7% bACC / +15.0% TWA on unseen real, 2,000× faster than VLM monitors; the coarse-supervised conformal monitor that sharpens SAFE's label noise.
