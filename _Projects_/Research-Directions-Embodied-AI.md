...
> [!abstract] Overview
> Twelve research directions at the VLA × World-Action-Model × Embodied-AI intersection, organized into four clusters — *Foundations: Data, Sensors, Substrates* (A), *Architecture & Training* (B), *Evaluation, Robustness & Deployment* (C), *Mobility & Embodiment Generalization* (D) — synthesized from ~56 VLA/WAM/embodied surveys, ten `Embodied-AI/` deep-dive readings, and the **frontier methods + benchmarks that set each bet's bar** (ACWM-Phys, stable-worldmodel, VISER, VLA-REPLICA, roto 2.0, LatentPilot, HEX, AnyBody). Clusters A–C treat the world action model as a fixed-base tabletop arm; Cluster D moves it through the world (navigation, loco-manipulation) and transfers it across bodies (cross-embodiment, morphology-invariance). Each direction carries an explicit **first-principles framing** — the irreducible structure of the problem, the conventional assumption it breaks, and a **measurable, falsifiable bet** — and a **non-consensus thesis** chosen for where impactful work deviates from incremental refinement. Every direction is actionable enough that a PhD student could start within a week, and every metric anchor is sourced from a cited `_KnowledgeHub_/{ID}.md` note — never invented.

> [!info] Scope
> Corpus: ~56 VLA/WAM/embodied/physics/safety surveys and ~120 method + benchmark papers from `_KnowledgeHub_/`, cross-checked against [[../General/08_Benchmarks-and-Surveys|General/08]] §4/§5/§7 and ten `Embodied-AI/` deep-dives. **Filter**: kept directions with 3–10 attacking papers but no consensus solution; excluded saturated (more-compute-only) and premature (hypothetical-AGI) framings; prioritized intersections (VLA×WAM, VLA×RL, WAM×egocentric, tactile×VLA, physics×RL, safety×deployment). **Methodology one-liner**: survey-grounded ideation — surveys enumerate open problems, benchmarks fix what is measurable, the closest existing methods + benchmarks fix what is currently achievable, and each direction states where it bets against the consensus. **Citation provenance**: every load-bearing number (Thesis / Key-targets / The-bet / Benchmark rows) was re-verified against the **full source-paper text** (via the alphaxiv `.md` render), not only the KH notes. This pass corrected one metric-label miscitation: the Physical-Feasibility VLA ([[2604.17896\|Physical-Feasibility VLA]]) **43.50%** figure is its *obstacle-perturbation Safe Success Rate* (Pr(d_min > α ∧ d_tgt < β)), not "LIBERO-Plus SSR" as previously labeled — the paper does not evaluate on LIBERO-Plus. The 43.50% number and the 22%→43.50% transition are real; only the benchmark attribution was wrong.

---

## Methodology

- **Survey enumeration**: ~56 unique surveys from `_KnowledgeHub_/` tag-scans (`survey` × {`VLA`, `world-model`, `embodied-AI`, `robotics`, `physics-aware`, `sim-to-real`, `safety`, `self-evolving`}) + reference sweeps of [[../Embodied-AI/03_VLA]], [[../Embodied-AI/04_WAM]], [[../Embodied-AI/07_Physics-Aware-Embodied-AI]]; cross-checked against [[../General/08_Benchmarks-and-Surveys|General/08]] §4/§5/§7.
- **Deep-dive mining**: full reads of the six deep-dives directly aligned with the directions ([[../Embodied-AI/04_WAM]], [[../Embodied-AI/06_Self-Evolving-VLA-WAM]], [[../Embodied-AI/07_Physics-Aware-Embodied-AI]], [[../Embodied-AI/08_VLA-Reasoning-and-CoT]], [[../Embodied-AI/10_Force-Aware-and-Tactile-Policies]], [[../Embodied-AI/11_Sim-to-Real-Transfer]]); others consulted for taxonomy framing.
...
- **Filter**: kept directions with 3–10 attacking papers but no consensus solution; excluded saturated (more-compute) and premature (hypothetical-AGI) framings; prioritized intersections (VLA×WAM, VLA×RL, WAM×egocentric, tactile×VLA, physics×RL, safety×deployment).
...
| [[2605.00080\|WM Robot Survey 2026]] | A: WAM | Eval beyond visual fidelity; closed-loop vs open-loop; latent WM dominance; causal conditioning; failure-recovery datasets; cross-embodiment |
| [[2605.03941\|iWorld-Bench]] | C: Eval & Benchmarking | Standardized interactive evaluation across WAM types |
| [[2605.05017\|Privacy-Utility Trade-off]] | C: Safety | Compositional leakage; regulatory-technical gap; non-linear utility trade-off (~30% SR drop); adaptive orchestration |
...
| [[2602.01630\|WM Research Critical Assessment]] | A: WAM | Fragmentation; need integrated module architecture; holistic understanding gap |
...
| [[2510.07077\|VLA Robotics Review 2025]] | A: VLA | Embodiment transfer; data scarcity; computational cost; eval+safety; gradient insulation/PEFT/inference optimization |
...
| [[2508.13073\|VLA Survey 2025]] | A: VLA | Partially superseded by later 2025 reviews |
...
| [[2504.03515\|Dexterous Imitation Survey]] | B: Modalities & Data | Tactile integration; cross-embodiment transfer; demo scaling |
...
| [[2503.04641\|Multimodal Generative World Simulators Survey]] | A: WAM | Cross-modal dependency; sparse 4D integration; comprehensive simulators |
...
| [[2512.24385\|Spatial Intelligence Pre-training Roadmap]] | B: Spatial Intelligence | Single → unified pre-training; 3D data scarcity; generative WM × spatial reasoning |
...
| [[2411.14499\|World Models Survey 2024]] | A: WAM | Physical-rule adherence; standardized benchmarks; sim2real; ethics/safety; interactive 3D action-conditioned WMs |
...
| [[2310.06253\|Objective-Mismatch Survey]] | C: Eval & Benchmarking | Decision-aware MBRL; predictive-loss vs return alignment; cross-family fragmentation |
| [[2103.04918\|Embodied AI Simulators Survey]] | C: Eval & Benchmarking | Simulator-task interconnections; realistic-physics + interactive-objects; cross-simulator benchmarking |
...
> - **Safety as a deployment-blocking axis** (4-way, *strengthened this pass*): [[2605.02900|Safety in Embodied AI Survey]] (five-layer attack taxonomy + cascade propagation), [[2604.23775|VLA Safety Survey]], [[2605.05017|Privacy-Utility Trade-off]], [[2511.05936|10 VLA Challenges]] (safety assurances named explicitly) — the field is converging on the realization that adversarial/jailbreak robustness and self-evolving misalignment are not separable from the evaluation and memory loops they corrupt.
...
|---|---|---|---|
| **A — Foundations** | A1, A2 | Contact-rich, multi-modal data scarcity (4-order gap vs OXE) | A2's cross-sensor tactile encoder is the deployment substrate A1 needs to make ego-pretrained policies transferable across platforms |
...
| **D — Mobility & Embodiment Generalization** | D1, D2, D3 | Policies assume a fixed base + fixed body; moving through the world and across morphologies breaks both (drift, coupling, 0% extrapolation) | D1's latent dream-ahead is the navigation analog of B1's latent loop; D2's coupling-aware whole-body model and D3's morphology-invariant representation share the *structure-preserving* lens — neither part-independent VLAs (D2) nor per-morphology retraining (D3) survives the OOD body; D3's invariant action space is the substrate D2 needs to transfer across humanoid platforms |
...
| **Key targets** | ≥80% of tactile-instrumented policy SR on ForceVLA 5 contact-rich tasks; [[2602.16710\|EgoScale]] **+54%** on 22-DoF dexterous |
...
- **The bet**: A VLA pretrained on ~20k hr of egocentric *video alone* achieves ≥80% of a tactile-instrumented policy's SR on ForceVLA's 5 contact-rich tasks — making force-aware policies trainable at internet-data scale instead of robot-data scale.
...
**Why it matters.** [[2604.15395|Foundation Models in Robotics Survey]] flags tactile scarcity as a top-3 bottleneck; [[2604.27621|Robot Learning from Human Videos Survey]] names tactile incorporation as one of 7 open problems; [[2604.16592|Cognition WM Survey]] names tactile-perception as under-represented. Architecturally the field has converged ([[2603.15169|ForceVLA2]] reaches 66% avg SR, +48 pp over π0) but every new platform restarts data collection. [[2410.24090|Sparsh]] / [[2506.14754|Sparsh-X]] train *per-sensor*; [[2601.20321|TaF-VLA]]'s 60.3% cross-sensor SR is not deployment-ready. The DINOv2 analog for touch — a representation invariant to sensor basis — does not yet exist.
...
- [[2603.15169|ForceVLA2]] — Cross-scale MoE + force prompts; **66%** avg SR; **+48 pp** over π0; consumes per-sensor tactile.
...
| **Thesis** | Single-loop co-evolution of VLA and WM — which the field treats as unstable and so trains cascaded or alternating — has the irreducible truth that the data carries $p(o',a\mid o,l)$ as one joint distribution, which breaks the assumption that WM↔policy alternation is necessary for stability, and I bet a single-step joint gradient on a unified latent backbone beats alternating training on *both* in-dist SR (≥97.2% LIBERO) and OOD SR (≥79.5% LIBERO-Plus) at no inference-latency cost (latent ~10 ms vs pixel ~150 ms). |
| **Anchor surveys** | [[2605.12090\|WAM Survey]], [[2605.00080\|WM Robot Survey 2026]], [[2604.22748\|Agentic World Modeling Survey]] |
| **Key targets** | LIBERO 97.2% in-dist; LIBERO-Plus 79.5% OOD; latent ~10 ms inference (vs pixel ~150 ms) |

**Why it matters.** [[2605.12090|WAM Survey]] formally defines WAMs via $\mathcal{L}_{\text{WAM}} = \mathbb{E}_{(o,l,o',a)\sim\mathcal{D}}[-\log p(o', a \mid o, l)]$ and identifies Joint over Cascaded as the frontier; [[2605.00080|WM Robot Survey 2026]] corroborates "single-backbone, unified VLA, latent world-modeling." Current "joint" implementations fall short: [[2602.12063|VLAW]] alternates; [[2603.16666|Fast-WAM]] drops the WM at deployment; [[2605.15153|Pelican-Unified]] unifies architecturally but trains multi-stage; [[2511.09515|WMPO]] and [[2511.15605|SRPO]] freeze the WM during inner RL. Gap: a single GRPO loop on joint $(action, imagination)$ log-prob with cooperative gradient flow is undemonstrated.
...
- **The bet**: One-shot gradient on a unified latent backbone beats multi-stage / alternating training on *both* in-distribution SR (≥97.2% target) and OOD SR (≥79.5% LIBERO-Plus target), at no inference latency cost.
...
- **Latent feasibility** ([[../Embodied-AI/03_VLA]] §5 + [[../Embodied-AI/04_WAM]] §5): [[2602.10098|VLA-JEPA]], [[2602.11832|JEPA-VLA]], [[2605.00078|Being-H0.7]] predict in 256-dim latent (~10 ms) vs pixel ~150 ms.
...
- [[2602.10098|VLA-JEPA]] / [[2602.11832|JEPA-VLA]] / [[2605.00078|Being-H0.7]] — Pure latent JEPA WMs; **97.2%** LIBERO; separate heads.
...
- [[2605.06732|On Training in Imagination]] — MBRL imagination theory + budget allocation; not wired into a latent joint loop.

**Benchmarks & metrics.**
- [[2306.03310|LIBERO]] + LIBERO-Plus + [[2602.06556|LIBERO-X]] + [[2603.28301|LIBERO-Para]] — Joint test suite for in-dist + OOD + compositional.
- [[2510.13626|LIBERO-Plus]] — 10,030 OOD perturbations; the OOD axis the joint loop must improve over alternating.
- [[2605.21800|stable-worldmodel]] — Reproducible WM harness; LeWM **94%** / DINO-WM **92%** Push-T baselines with sharp planning decay under perturbation — substrate to check the joint loop's latent doesn't collapse under shift.
...
5. **Q5 — Inference cost ablation.** Explicit CoT (~1.2s) vs [[2604.22709|Abstract-CoT]] (~50ms) vs [[2604.18486|OneVL]] (~0ms) vs OneVL+CIR/SR (~0ms) across {ID, OOD, Compositional}.
...
**Benchmarks & metrics.**
- NAVSIM — Driving CoT benchmark; cross-domain reasoning-faithfulness anchor.
...
2. **Q2 — Implicit vs abstract vs explicit interface ablation** (per [[2604.04974|Video-to-Control Survey]] taxonomy). Same backbone, matched FLOPs; report Safe-SR on a [[2604.17896|Physical-Feasibility VLA]]-style obstacle-perturbation gauntlet + a new 20-task physics gauntlet + [[2605.08567|ACWM-Phys]] OOD splits, and separately track plain SR on LIBERO-Plus. Target: lift the obstacle-perturbation Safe-SR ceiling from 43.50% → >55%; latent within ±2 pp at lower latency.
...
5. **Q5 — Reward-hacking diagnostics**: D1 static-output detection (σ drop > 2×); D2 $\rho(\sum P_i, \text{task SR})$ regression; D3 periodic [[2412.02818|RoboMD]] adversarial probing. Defense: [[2509.15194|EVOL-RL]] novelty diversity.
...
- [[2605.15458|Video-RLVR]] — RL with verifiable rewards on video diffusion; no action chain.
- [[2605.15298|PhysBrain 1.0]] — Physics-aware VLA from egocentric; closest physics-grounded VLA, but no verifiable predicate set.
...
- Obstacle-perturbation Safe-SR gauntlet ([[2604.17896|Physical-Feasibility VLA]] protocol) + 20-task physics gauntlet — action-level physics Safe-SR; target: 43.50% → >55%. LIBERO-Plus tracked separately as a plain-SR robustness axis (the 43.50% is *not* a LIBERO-Plus number).
...
- **The bet**: ASR + COD *jointly* predict real-fleet SR at Pearson **ρ > 0.7** — far above the ρ < 0.4 ceiling of separate-axes evaluation — making the metric pair the practical replacement for current WM eval practice.
...
- [[2605.21800|stable-worldmodel]] — Reproducible OOD harness; LeWM 94% / DINO-WM 92% Push-T, quadratic planning decay under occlusion — the perturbation substrate the joint metric must be sensitive to.
...
- [[2603.13966|vla-eval]] — Unified eval harness; **47×** LIBERO speedup; no joint causal metric.
- [[2605.21800|stable-worldmodel]] — Reproducible OOD WM platform; LeWM 94% / DINO-WM 92% Push-T; planning decay under perturbation; no joint causal metric.
...
- [[2601.04137|WowWoVal]] — Comprehensive embodied WM eval Turing test.
- [[2602.08971|WorldArena]] — Unified perception + functional utility for embodied WMs.

**Benchmarks & metrics.**
- LIBERO + [[2510.13626|LIBERO-Plus]] — Action SR baseline; ~40k pairs.
...
| **Key targets** | ≥+15 pp SR on RoboMemArena memory-dependent subtasks (current best: ECHO-VLA **+12.8 pp**); oscillation incidents **−50%**; ARMADA **23.3%** intervention reduction |
...
- **The bet**: An integrated detect-diagnose-recover loop with memory consultation improves long-horizon real-robot SR by ≥+15 pp on [[2605.10921|RoboMemArena]]'s memory-dependent subtasks (current best: [[2605.10993|ECHO-VLA]]'s +12.8 pp on memory alone), AND reduces oscillation incidents by ≥50% via state-machine integration.
...
- [[2605.14539|Correction-Oriented PO]] — RL from failure traces with verifiable rewards.
- [[2605.15735|UAM Dual-Stream]] — VLA forgetting under fine-tune; the catastrophic-forgetting risk the continual loop must avoid.
...
|---|---|
| **Cluster** | C — Evaluation, Robustness & Deployment |
| **Thesis** | Efficiency as a primary research target — which the field dismisses as "engineering, not science" to be sorted after publication — has the irreducible truth that inference cost has three independent levers (what / how often / how precisely you predict) whose Pareto frontier requires co-design, which breaks the assumption that single-lever optimization or hardware progress suffices, and I bet a co-designed (architecture + training + data + quantization) VLA hits ≥30 Hz on edge (Jetson Orin / Apple M, vs the AR 3–5 Hz ceiling) while retaining ≥95% of base-policy SR — showing the latency-quality Pareto curve moves with methodology, not just silicon. |
| **Anchor surveys** | [[2510.24795\|Efficient VLA Survey]], [[2510.07077\|VLA Robotics Review 2025]], [[2603.28489\|Video Gen as WM Survey]] |
| **Key targets** | ≥30 Hz on Jetson Orin / Apple M (vs AR 3–5 Hz ceiling); ≥95% of base-policy LIBERO SR retained; matched-FLOPs Pareto sweep |

**Why it matters.** [[2510.24795|Efficient VLA Survey]] and [[2603.28489|Video Gen as WM Survey]] reframe efficiency from "optimization" to "fundamental prerequisite." [[2505.04769|VLA Concepts Survey]] quantifies: AR decoding limits speed to 3–5 Hz vs 20–50 Hz needed. [[2510.07077|VLA Robotics Review 2025]] names latency as a top-3 deployment concern; [[2511.05936|10 VLA Challenges]] names resource efficiency as one of ten core bottlenecks. None of A1–C2 tackle efficiency as a primary thesis — they implicitly assume real-time is feasible.

**First-principles framing.**
- **First principle**: Inference cost has three independent levers — *what you predict* (architecture / representation), *how often you predict* (decoding strategy / frequency), and *how precisely* (numerical precision). Single-lever optimization saturates; the Pareto frontier requires co-design across all three axes simultaneously.
- **Assumption being challenged**: That efficiency is "engineering, not research" — a footnote to the science to be sorted out after publication. In closed-loop manipulation, 3–5 Hz vs 30 Hz isn't a tuning parameter; it determines whether the policy is *usable at all*. Efficiency is therefore a first-class scientific axis, not a deployment afterthought.
- **The bet**: Co-designed (architecture + training + data + quantization) VLAs hit ≥30 Hz on edge hardware (Jetson Orin / Apple M) while retaining ≥95% of base-policy SR — demonstrating that the latency-quality Pareto curve isn't fixed but can be moved by methodological innovation, not just hardware progress. (The 95% bar is a design-chosen target, not a paper-reported figure.)

**Evidence.**
- **Model-side**: SARA-RT, RoboMamba (linear-time / Mamba; not in-vault), [[2605.14598|DSSP]] (diffusion state-space policy), parallel action decoding, quantization + pruning + distillation (rarely co-optimized).
...
4. **Q4 — Real-time joint VLA+WM in latent space.** B1's joint loop with a Mamba latent WM ([[2511.15605|SRPO]] V-JEPA-2 substrate) should run >30 Hz.
5. **Q5 — Edge deployment chain**: train → quantize → distill → deploy on Jetson Orin / Apple M; measure SR retention at each stage; validate cross-lab via [[2605.20774|VLA-REPLICA]].
...
- [[2510.07077|VLA Robotics Review 2025]] — Names latency as a top-3 deployment concern.
...
- [[2605.14598|DSSP]] — Diffusion state-space policy with efficient full-history SSM encoding; **62.30%** RoboTwin 2.0 at a smaller footprint; the in-vault linear-time-backbone exemplar (RoboMamba itself is not in-vault).
- [[2505.23705|Knowledge Insulation VLA]] — Stop-gradient PEFT pattern.
- [[2602.16710|EgoScale]] — Log-linear ego scaling; **+54%** dexterous.
- [[2511.15605|SRPO]] — Frozen V-JEPA-2; ~10 ms inference; inference-only.
...
> - **Edge-hardware diversity** — Jetson vs Apple M vs custom NPUs need per-platform tuning. → Validate cross-platform via [[2605.20774|VLA-REPLICA]]'s reproducibility protocol rather than a single device.
...
| **Key targets** | ≥+9.7 pp old-task SR over Data Replay ([[2510.20685\|C-Nav]] **42.61% vs 32.9%** HM3D); embodiment tax **<5%** ([[2605.15735\|UAM]]); ≤−3 pp new-task SR vs full fine-tune |
...
- [[2510.20685|C-Nav]] — Dual-Path Anti-Forgetting (representation-drift + policy-degradation) + LOF keyframe selection beats Data Replay by **+9.7 pp** old-task SR (**42.61%** vs **32.9%**) on HM3D, replay-free, half the data.
...
- [[2211.15944|Continual-Dreamer]] — Replay + Plan2Explore in a world model mitigates forgetting on MiniHack; the WM-side analog showing latent rollouts can carry continual structure.
...
3. **Q3 — Embodiment-tax probe.** After each fine-tune, re-run the frozen VLM's multimodal suite (MMMU/MME/MMBench). Pass: tax stays <5% across ≥5 sequential tasks (vs full fine-tune's degradation).
...
**Benchmarks & metrics.**
- [[2510.20685|C-Nav]] continual object-nav benchmark — first continual-nav suite; old-task SR **42.61%** (C-Nav) vs **32.9%** (Data Replay) HM3D final stage; the head-to-head C4 must extend to manipulation.
- [[2510.13626|LIBERO-Plus]] — 10,030 OOD perturbations; sequence LIBERO task suites to measure forgetting under distribution shift.
- [[2502.09560|EmbodiedBench]] — General embodied eval; whole-capability retention check after a continual fine-tune sequence.
- MMMU / MME / MMBench (via [[2605.15735|UAM]]) — multimodal-competence suite for the embodiment-tax measurement.
...
*Clusters A–C treat the robot as a fixed-base tabletop arm; this cluster moves it through the world (navigation, loco-manipulation) and transfers it across bodies (cross-embodiment, morphology-invariance) — where both the fixed-base and fixed-body assumptions break.*
...
- **The bet**: An in-policy latent dream head, optionally self-evolving online, matches or beats external-WM VLN SOTA — ≥62.0% SR / 58.0% SPL on R2R-CE Val-Unseen at ≤130 ms / 22.8 GB ([[2603.29165|LatentPilot]]) and ≥+4.1% online-adaptation SR at 2.1× the speed of gradient adaptation ([[2506.23468|NavMorph]]) — proving foresight is a representation choice, not an external module.

**Evidence.**
- [[2603.29165|LatentPilot]] — Pilot Token in-policy latent dreaming; **62.0% SR / 58.0% SPL** R2R-CE Val-Unseen at **130 ms / 22.8 GB**; future obs as privileged supervision (PilotLoop).
- [[2506.23468|NavMorph]] — Self-evolving RSSM world model + Contextual Evolution Memory; **+4.1% SR / +2.73% SPL** RxR-CE unseen, **2.1×** faster than gradient adaptation, no backprop at test time.
- [[2605.22816|AwareVLN]] — Reasoning-augmented VLN; **73.5% SR / 65.4% SPL** R2R-CE Val-Unseen, monocular RGB, strong sim-to-real; the reasoning-heavy alternative latent dreaming must justify itself against on efficiency.
- [[2411.04983|DINO-WM]] — Latent world model planning in DINOv2 feature space; the manipulation-side proof that latent rollouts plan without pixel decoding.
- [[2402.19161|MemoNav]] — Goal-aware working memory for image-goal navigation; the memory-as-foresight precursor NavMorph's CEM generalizes.

**Concrete research questions.**
1. **Q1 — Fuse in-policy dreaming with online self-evolution.** Bolt [[2506.23468|NavMorph]]'s Contextual Evolution Memory onto [[2603.29165|LatentPilot]]'s Pilot Token: does test-time CEM update improve the dreamed latent without adding the gradient-adaptation cost? Target: retain ≤130 ms while gaining NavMorph's +4.1% online-adaptation SR.
2. **Q2 — Latent dream horizon ablation.** Vary the imagined horizon (1-step vs k-step Pilot-Token rollout); measure SR/SPL vs latency. Where does deeper latent dreaming stop paying off on R2R-CE / RxR-CE?
3. **Q3 — Privileged-supervision transfer.** [[2603.29165|LatentPilot]]'s PilotLoop uses future observations as privileged supervision in sim — does this latent dynamics signal transfer to real-world deployment (VLN-PE Fall/Stuck rate) without sim-only collapse?
...
5. **Q5 — Cross-embodiment nav deployment.** [[2603.29165|LatentPilot]] deploys across diverse robot embodiments; does the latent dream head transfer zero-shot to a new mobile base, or does it need D3-style morphology-invariance?

**Related research papers.**
- [[2603.29165|LatentPilot]] — In-policy Pilot Token latent dreaming; **62.0% SR** R2R-CE; SOTA accuracy + efficiency; no online self-evolution.
...
- [[2604.08509|Visually-grounded Humanoid Agents]] — Humanoid VLN agents; the embodiment D1's nav head must eventually drive (bridge to D2).
...
**Benchmarks & metrics.**
- R2R-CE Val-Unseen — Continuous-environment VLN; [[2603.29165|LatentPilot]] **62.0% SR / 58.0% SPL**, [[2605.22816|AwareVLN]] **73.5% SR**; the headline efficiency-vs-accuracy battleground.
- RxR-CE Val-Unseen — Multilingual long-instruction VLN; [[2506.23468|NavMorph]] **+4.1% SR / +2.73% SPL** online adaptation; the self-evolution axis.
- VLN-PE — Physical-embodiment VLN; [[2603.29165|LatentPilot]] **10.65%** Fall Rate / **0.97%** Stuck Rate; the sim-to-real robustness axis.

> [!warning] Risks
> - **Latent dreaming may not help on long-horizon RxR-CE** — Pilot Token foresight could plateau where explicit reasoning ([[2605.22816|AwareVLN]]) still wins. → Q4's head-to-head bounds the claim to the regimes where latent foresight is cost-competitive; report where it loses.
...
> - **Sim-only privileged supervision** — PilotLoop's future-obs supervision exists only in sim; real deployment loses it. → Q3 validates VLN-PE transfer before claiming real-world foresight; fall back to NavMorph's unsupervised CEM if it collapses.

### D2 — Coupled-Dynamics Whole-Body Action Models for Humanoid Loco-Manipulation

| | |
|---|---|
| **Cluster** | D — Mobility & Embodiment Generalization |
| **Thesis** | A coupling-aware whole-body action model — which the field forgoes because most VLAs treat body parts as independent action heads — has the irreducible truth that on a humanoid the arms and legs share one dynamics (an aggressive arm move *is* a balance disturbance), so part-independence discards the exact cross-part structure long-horizon loco-manipulation depends on, which breaks the assumption that upper-body manipulation and lower-body locomotion can be modeled separately, and I bet an explicitly coupled whole-body model beats part-independent VLAs on OOD loco-manipulation by ≥10 pp — [[2604.07993\|HEX]] **79.8% ID / 61.8% OOD** (vs GR00T N1.5 70.2% / π0.5 44.3% OOD), with [[2602.06341\|HiWET]] world-frame tracking halving EE error to **12.4 mm**. |
| **Anchor surveys** | [[2511.05936\|10 VLA Challenges]], [[2604.15395\|Foundation Models in Robotics Survey]], [[2505.07634\|Neural Brain Framework]] |
| **Key targets** | ≥61.8% OOD whole-body SR ([[2604.07993\|HEX]], vs π0.5 **44.3%**, GR00T N1.5 **41.0%**); world-frame EE error ≤12.4 mm sim / 12–15 mm real ([[2602.06341\|HiWET]]) |

**Why it matters.** [[2511.05936|10 VLA Challenges]] names *whole-body coordination* as one of ten core VLA bottlenecks; [[2604.15395|Foundation Models in Robotics Survey]] flags long-horizon humanoid control as under-served. The structural diagnosis is sharp: [[2604.07993|HEX]] shows existing VLAs "treat robot body parts independently, leading to uncoordinated and unstable behaviors on high-DoF humanoids," and fixes it with a morphology-based MoE Unified Proprioceptive Predictor — reaching **79.8% ID** and **61.8% OOD** SR, beating GR00T N1.5 (70.2% / 41.0%) and π0.5 (44.3% OOD). [[2602.06341|HiWET]] attacks the same coupling from the control side: robot-centric control accumulates world-frame drift, so world-frame end-effector tracking with a Kinematic Manifold Prior *halves* hand error to **12.4 mm**. [[2505.06776|FALCON]] and [[2502.01143|ASAP]] establish the RL whole-body substrate. The gap: no work unifies HEX's coupling-aware *predictive* model with HiWET's world-frame *tracking* into a single whole-body world action model evaluated on OOD loco-manipulation.

**First-principles framing.**
- **First principle**: A humanoid's upper and lower body share *one* coupled dynamics — an arm acceleration is a momentum disturbance the legs must absorb. The cross-part Jacobian is non-zero by construction, so any model that factors the body into independent per-part action heads is throwing away the exact term that long-horizon loco-manipulation stability depends on.
- **Assumption being challenged**: That manipulation (upper body) and locomotion (lower body) can be learned as separate modules and composed. [[2604.07993|HEX]] empirically shows part-independent VLAs go "uncoordinated and unstable" on high-DoF humanoids; [[2602.06341|HiWET]] shows robot-centric (non-world-frame) control accumulates drift — both are symptoms of the same factorization error the field inherited from fixed-base manipulation.
- **The bet**: An explicitly coupled whole-body action model (morphology-aware MoE predictor + world-frame tracking) beats part-independent VLAs on OOD loco-manipulation by ≥10 pp — clearing [[2604.07993|HEX]]'s **61.8% OOD** (vs π0.5 44.3%, GR00T N1.5 41.0%) while holding [[2602.06341|HiWET]]'s **12.4 mm** world-frame EE precision — proving coupling is a modeling requirement, not a controller afterthought.

**Evidence.**
- [[2604.07993|HEX]] — Morphology-based MoE Unified Proprioceptive Predictor + review-and-forecast; **79.8% ID / 61.8% OOD** SR, beats GR00T N1.5 and π0.5; structured cross-part proprioception.
- [[2602.06341|HiWET]] — Hierarchical world-frame EE tracking (Commander/Tracker) + Kinematic Manifold Prior; **12.4 mm** sim error (KMP halves it), zero-shot sim-to-real on Unitree G1.
- [[2505.06776|FALCON]] — Dual-agent RL loco-manipulation; **~2×** lower upper-body tracking error under force, 1.2 kg/hand payloads on G1 + Booster T1.
- [[2502.01143|ASAP]] — Real-world-aligned whole-body humanoid policy; the sim-to-real dynamics-gap substrate coupling-aware training builds on.
- [[2502.14795|Humanoid-VLA]] — Whole-body humanoid VLA; mean position error <**40 mm**, real G1 deployment; the VLA-side whole-body baseline.

**Concrete research questions.**
1. **Q1 — Unify coupling-aware prediction with world-frame tracking.** Feed [[2604.07993|HEX]]'s MoE proprioceptive prediction into [[2602.06341|HiWET]]'s world-frame Tracker: does predicting coupled future proprioception improve world-frame EE precision under aggressive arm motion? Target: hold 12.4 mm while extending to long-horizon.
2. **Q2 — Cross-part coupling ablation.** Compare independent per-part heads vs HEX's morphology-MoE vs a full cross-part attention predictor on OOD scene variations. Quantify the OOD-SR cost of factorization (hypothesis: ≥10 pp).
3. **Q3 — Coupling under disturbance.** Inject external force/payload ([[2505.06776|FALCON]] protocol) during manipulation; measure how coupling-aware vs part-independent models preserve EE precision and gait stability.
4. **Q4 — Long-horizon loco-manipulation.** [[2604.07993|HEX]]'s "box convey" multi-stage task (100% stage-1, 53.3% Place-Box); does coupled prediction raise the long-horizon completion rate over the π0.5 baseline (40.0%)?
5. **Q5 — Whole-body world action model.** Train a *joint* $p(o', a_{\text{whole-body}} \mid o, l)$ on humanoid trajectories (HEX's 12M frames); does the coupled imagination transfer across humanoid platforms (G1 → T1)?

**Related research papers.**
- [[2604.07993|HEX]] — Coupling-aware MoE proprioceptive predictor; **61.8% OOD**; cross-embodiment whole-body manipulation.
- [[2602.06341|HiWET]] — World-frame EE tracking + KMP; **12.4 mm**; control-side coupling, no predictive model.
- [[2505.06776|FALCON]] — Dual-agent RL loco-manipulation under force; **~2×** lower tracking error; no VLA / language conditioning.
- [[2502.01143|ASAP]] — Real-world-aligned whole-body policy; sim-to-real dynamics matching.
- [[2502.14795|Humanoid-VLA]] — Whole-body humanoid VLA; <**40 mm** position error; motion-synthesis-centric.
- [[2503.05652|BRS]] — Whole-body bimanual mobile manipulation system; the integrated-platform reference.
- [[2408.14472|DWL]] — Robust humanoid locomotion via RL; the locomotion substrate loco-manipulation extends.
- [[2604.08509|Visually-grounded Humanoid Agents]] — Humanoid agents grounded in vision; the perception-side bridge to D1's nav head.
- [[2602.04411|Self-evolving Embodied AI]] — Names embodiment integration (WM + memory + body) as unsolved; the coupling story is one instance.

**Benchmarks & metrics.**
- [[2403.10506|HumanoidBench]] — Whole-body humanoid manipulation + locomotion benchmark; the standardized suite coupled-vs-independent models should be compared on.
- [[2604.07993|HEX]] real-robot suite — 7 ID tasks (**79.8%**) + 8 OOD variants (**61.8%**) + multi-stage box-convey; the OOD whole-body SR anchor.
- [[2602.06341|HiWET]] world-frame tracking — **12.4 mm** sim / **12–15 mm** real EE RMSE on Unitree G1; the precision axis.

> [!warning] Risks
> - **Coupling-aware models may overfit one morphology** — HEX's MoE is humanoid-specific; the cross-part structure differs per platform. → Q5 tests G1 → T1 transfer explicitly; pair with D3's morphology-invariant representation if single-platform overfit appears.
> - **World-frame tracking needs accurate state estimation** — [[2602.06341|HiWET]] flags drift compensation depends on it; real deployment degrades it. → Report EE error under realistic state-estimation noise, not just clean sim.
> - **Whole-body world action model may be too expensive for closed loop** — joint $p(o', a_{\text{whole-body}})$ over high-DoF is costly. → Co-design with C3's efficiency budget; predict in latent (D1 / B1 lens) rather than pixel space.

### D3 — Morphology-Invariant Action Representations for Cross-Embodiment Zero-Shot Transfer

| | |
|---|---|
| **Cluster** | D — Mobility & Embodiment Generalization |
| **Thesis** | A morphology-invariant action representation — which the field forgoes because it tokenizes actions in each robot's native joint space — has the irreducible truth that "pick up the cup" names the same *task intent* regardless of the arm executing it, so an embodiment-agnostic action space is the natural representation and per-morphology tokenization is the accidental one, which breaks the assumption that cross-embodiment transfer needs per-robot fine-tuning, and I bet a morphology-invariant representation breaks AnyBody's extrapolation wall — [[2505.14986\|AnyBody]] reports **0%** zero-shot SR on novel link structures, while [[2602.10556\|LAP]]'s language-action space hits **>50%** zero-shot (**2×** prior VLAs) and [[2605.20811\|Demo-JEPA]] reaches **0.36 vs 0.04** one-shot — target **>30%** on AnyBody's extrapolation split. |
| **Anchor surveys** | [[2510.07077\|VLA Robotics Review 2025]], [[2504.03515\|Dexterous Imitation Survey]], [[2604.04707\|OpenWorldLib]] |
| **Key targets** | >30% extrapolation SR on [[2505.14986\|AnyBody]] novel-morphology split (current **0%**); >50% zero-shot cross-embodiment ([[2602.10556\|LAP]], **2×** prior VLAs); **0.36** one-shot ([[2605.20811\|Demo-JEPA]], vs **0.04** VPP) |

**Why it matters.** [[2505.14986|AnyBody]] is the brutal diagnostic: multi-embodiment policies match single-embodiment baselines on *seen* robots and *interpolation*, but collapse to **0%** SR on *extrapolation* to fundamentally different link structures. [[2510.07077|VLA Robotics Review 2025]] names embodiment transfer a top open problem; [[2504.03515|Dexterous Imitation Survey]] names cross-embodiment transfer a core barrier. The promising counter-evidence is about *representation choice*: [[2602.10556|LAP]] parses continuous actions into *natural language* ("language-actions"), aligning the action space with the VLM's pretraining, and hits **>50%** zero-shot across unseen embodiments (**2×** prior VLAs, 2.5× fewer demos to fine-tune); [[2605.20811|Demo-JEPA]] abstracts demonstrations into *target-compatible latent goals*, reaching **0.36** one-shot SR vs VPP's **0.04**. Both replace native-joint-space tokenization with an invariant intermediate — but neither has been tested against [[2505.14986|AnyBody]]'s extrapolation wall, which remains the unbeaten 0% benchmark.
...
**Evidence.**
- [[2505.14986|AnyBody]] — 18-robot cross-embodiment benchmark; interpolation transfers, extrapolation/composition collapse to **0%**; the wall D3 must break.
...
- [[2605.20811|Demo-JEPA]] — JEPA target-compatible latent goals; **0.36** sim / **0.25** real one-shot (vs VPP **0.04** / XSkill **0.03**); demonstration-as-latent-goal abstraction.
- [[2409.20537|HPT]] — Heterogeneous pre-training with shared trunk + per-embodiment stems; **10–30%** transfer gain; the stem-tokenizes-per-robot baseline D3 challenges.
- [[2510.10274|X-VLA]] — Soft-prompt cross-embodiment VLA; SOTA on 5/6 benchmarks, **93%** LIBERO at 1% params; strong but still adapts per platform.
- [[2505.06111|UniVLA]] — Unified cross-task/embodiment VLA; **95.2%** LIBERO, **47.1%** R2R; latent-action backbone.

**Concrete research questions.**
1. **Q1 — Invariant-representation bake-off on AnyBody.** Run [[2602.10556|LAP]] (language-action), [[2605.20811|Demo-JEPA]] (latent goal), and task-space tokenization head-to-head on [[2505.14986|AnyBody]]'s extrapolation/composition splits. Which invariant beats 0%? Target: >30% extrapolation SR.
...
3. **Q3 — Composing language-action + latent-goal.** Does [[2602.10556|LAP]]'s language intermediate + [[2605.20811|Demo-JEPA]]'s latent goal compose (language for *what*, latent for *how-on-this-body*)? Target: beat either alone on AnyBody composition.
...
5. **Q5 — Transfer to mobile / whole-body bodies (D2 bridge).** Does the invariant representation extend from fixed arms to D2's humanoid whole-body, or does coupling (D2) break the intent-invariance assumption?
...
- [[2510.10274|X-VLA]] — Soft-prompt cross-embodiment; **93%** LIBERO at 1% params; per-platform adaptation.
- [[2505.06111|UniVLA]] — Unified latent-action VLA; **95.2%** LIBERO; cross-task + cross-embodiment.
- [[2212.06817|RT-1]] — Foundational cross-embodiment robot transformer; native action tokens.
- [[2507.23682|villa-X]] — Latent-action cross-embodiment VLA; the latent-action lineage Demo-JEPA extends.
...
- [[2605.20811|Demo-JEPA]] one-shot cross-embodiment — sim **0.36** / real **0.25** vs VPP **0.04** / XSkill **0.03**; the one-shot imitation axis.
...
> - **AnyBody's 0% may be partly task-hardness, not pure morphology** — extrapolation tasks could be intrinsically harder. → Control with interpolation SR on the *same* tasks; attribute the gap to morphology only if interpolation succeeds.
> - **Language-actions discretize continuous control** — [[2602.10556|LAP]]'s parsing may lose high-frequency detail. → Pair the language intermediate with a knowledge-insulated continuous action expert (LAP's own design) rather than acting in language directly.
...
| Causal faithfulness of latent reasoning under compositional novelty | B2 | NAVSIM (driving CoT) + [[2510.16281\|SEAL]] (runtime verifier, not benchmark) |
...
| OOD whole-body loco-manipulation with coupled cross-part dynamics | D2 | [[2604.07993\|HEX]] (coupling-aware predictor, **61.8% OOD**) + [[2602.06341\|HiWET]] (world-frame tracking, no predictive model) + [[2403.10506\|HumanoidBench]] (no coupling axis) |
| Zero-shot extrapolation to novel link structures (morphology-invariant) | D3 | [[2505.14986\|AnyBody]] (**0%** extrapolation wall) + [[2602.10556\|LAP]] (**>50%** zero-shot, untested on AnyBody) + [[2605.20811\|Demo-JEPA]] (**0.36** one-shot) |
...
- [[../Embodied-AI/11_Sim-to-Real-Transfer]] — Zero-shot sim-to-real for humanoid loco-manipulation (D2) + cross-embodiment transfer (D3)
- [[../Embodied-AI/02_Dataset-Benchmark-Environment]] — Data + sim + benchmark stacks (AnyBody, HumanoidBench, VLN-CE)
- [[../General/07_Robotics-and-Embodied-AI]] — Navigation, humanoid, and cross-embodiment paper index (Cluster D)
- [[../General/08_Benchmarks-and-Surveys]] — Canonical survey index
- [[Research-Directions-WAM]] — Focused WAM deep-dive sibling. Hosts the WAM-internal directions (representation substrate, contact-mode latent, calibrated imagination, 4D geometry, persistent-memory imagination); this umbrella doc develops the cross-family directions WAM hands off (B1, B3, C1, C3, D3). Note: WAM's **C2 — Persistent-Memory imagination** is distinct from this doc's **C2 — Memory + Failure-Recovery loop**.
- [[Research-Directions-Sim2Real]] — Sibling doc on sim-to-real / real-to-sim transfer; borders this doc's physics-consistency (B3) and world-model-as-simulator directions.
