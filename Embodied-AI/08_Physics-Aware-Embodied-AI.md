...
- **[[2602.13294|VisPhyWorld]]** — A benchmark forcing MLLMs to reconstruct events as ==executable simulator code== (**VisPhyBench**, 209 scenes) rather than free-text, decoupling reasoning from rendering; models nail perceptual/semantic reconstruction (low LPIPS, high CLIP-Img) but ==fail to infer accurate physical parameters==, giving plausible-looking yet physically inconsistent motion.
