...
- **[[2512.04341|NEUBAY]]** — A model-based offline-RL method optimizing expected return under a ==posterior distribution over world models== (==N=100 ensemble==) for ambiguity-neutral performance, with ==epistemic-uncertainty== adaptive trajectory truncation and history-dependent recurrent actor-critics; new SOTA on 7 of 33 D4RL/NeoRL tasks (walker-medium 95.5→106.4), no explicit conservatism.
