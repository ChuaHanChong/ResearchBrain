...
- **[[2602.09017|CAP]]** — Conditions a ==VQ-BeT== policy on ==3D contact anchor== points instead of language, with **EgoGym** — a lightweight, non-photorealistic ==procedurally generated== MuJoCo suite — for rapid iteration and failure-mode ID, not training realism; **81-96%** zero-shot pick/open/close across four real embodiments from **23h** of demos, **+56%** over π0.5-DROID on Franka Pick.
