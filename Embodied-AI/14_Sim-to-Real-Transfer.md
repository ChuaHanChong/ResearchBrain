...
- **[[2505.12462|Model-Free-Robust-Avg-Reward-RL]]** — A model-free ==Robust Halpern Iteration== for *average-reward* robust RL targeting the sim-real gap, using a ==quotient-space== formulation + ==K-order multi-level Monte-Carlo== bias-reduced oracle over ==KL / χ² / ℓp uncertainty sets==; first finite-sample ε-optimal guarantees matching model-based bounds for steady-state robust transfer.
...
#### 4.5 Learned & Bayesian Real2Sim Calibration
...
See [[08_Physics-Aware-Embodied-AI#4. External Simulator Coupling]] for the external-simulator coupling perspective.
...
| Need a digital twin? | [[2503.17973\|PhysTwin]] (deformable) or [[2511.07416\|PhysWorld]] (robot policy) — see [[08_Physics-Aware-Embodied-AI#4. External Simulator Coupling]] |
...
- [[08_Physics-Aware-Embodied-AI]] — Physics priors; §4 External Simulator Coupling overlaps real2sim2real
