...
- **[[2602.16710|EgoScale]]** — A *deployment-predictive* log-linear scaling law in action-prediction validation loss over **20,854 hours** of heterogeneous egocentric data. **+54%** task SR on 22-DoF dexterous hand; **88%** shirt-folding and **55%** bottle-unscrewing from a single robot demo; **+30%** cross-embodiment on 7-DoF tri-finger transfer. Two-stage recipe keeps the curve flat at scale.
