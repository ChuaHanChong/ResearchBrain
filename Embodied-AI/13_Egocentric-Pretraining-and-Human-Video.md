...
- **[[2605.14742|EARL]]** — A unified ==analysis-guided RL== framework for egocentric interaction reasoning + pixel grounding that runs coarse-to-fine: a holistic interaction descriptor feeds an ==Analysis-guided Feature Synthesizer== and ==GRPO== with format/answer/grounding rewards; **65.48%** cIoU on Ego-IRGBench (**+8.37%** SOTA), **38.21%** OOD cIoU on EgoHOS.
