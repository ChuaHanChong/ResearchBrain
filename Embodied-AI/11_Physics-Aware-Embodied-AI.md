...
- **[[2506.09987|MVP Video-QA]]** — Shortcut-aware video-QA via ==Minimal Video Pairs==: each question pairs with a minimally-different counter-video so single-frame / text-prior shortcuts fail; humans hit **92.9%** but the best VideoLLM only **40.2%**, most near the **25%** chance floor — random-pairing ablation drops **18.1%**, so reported physics scores overstate true understanding.
