...
- **[[2503.13082|FreeGrasp]]** — A zero-shot pipeline where ==GPT-4o== reasons over ==mark-based visual prompting== to sequentially pick the next object (target or obstructor) for free-form-language grasping in clutter, with Molmo localization, LangSAM segmentation, and GraspNet poses, plus the FreeGraspData benchmark; beats ThinkGrasp on ambiguous/occluded scenes — reasons next-object selection.
