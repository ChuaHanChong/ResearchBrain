...
- Existing models struggle with effectively processing and memorizing very long sequences, facing challenges with generalization and length extrapolation
...
- Introduces a ==neural long-term memory module== that learns to memorize at test time using a combination of momentary and past surprise with an ==adaptive forgetting mechanism==
...
- Outperforms Transformers and modern recurrent models across language modeling, reasoning, and long-context tasks, including better needle-in-haystack performance than much larger models like GPT-4
...
> - Events that violate expectations (surprising) should be more memorable, and deep memory networks are more effective than linear/shallow ones for memorization
