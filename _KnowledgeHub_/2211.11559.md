...
- Prior neuro-symbolic visual reasoning systems required learning to compose low-level neural modules end-to-end, offering less flexibility than higher-level, training-free program generation.
...
#### 2.1. The Problem with End-to-End Visual Reasoning
...
#### 3.2. Module Categories and Functions
...
#### 3.3. Program Generation and Execution
...
#### 4.1. Visual Tasks and Performance
...
#### 4.2. Compositional Visual Question Answering
...
#### 4.3. Natural Language Visual Reasoning
...
#### 4.4. Factual Knowledge Object Tagging
...
#### 4.5. Language Guided Image Editing
...
#### 4.6. Advantages of Visual Rationales
...
Tom B. Brown, Benjamin Mann, Nick Ryder, Melanie Subbiah, Jared Kaplan, Prafulla Dhariwal, Arvind Neelakantan, Pranav Shyam, Girish Sastry, Amanda Askell, Sandhini Agarwal, Ariel Herbert-Voss, Gretchen Krueger, T. J. Henighan, Rewon Child, Aditya Ramesh, Daniel M. Ziegler, Jeff Wu, Clemens Winter, Christopher Hesse, Mark Chen, Eric Sigler, Mateusz Litwin, Scott Gray, Benjamin Chess, Jack Clark, Christopher Berner, Sam McCandlish, Alec Radford, Ilya Sutskever, and Dario Amodei. [[2005.14165|Language models are few-shot learners]]. ArXiv, abs/2005.14165, 2020. 2, 3
...
Alec Radford, Jong Wook Kim, Chris Hallacy, Aditya Ramesh, Gabriel Goh, Sandhini Agarwal, Girish Sastry, Amanda Askell, Pamela Mishkin, Jack Clark, et al. [[2103.00020|Learning transferable visual models from natural language supervision]]. In International Conference on Machine Learning, pages 8748–8763. PMLR, 2021. 2, 3, 12
...
Jason Wei, Xuezhi Wang, Dale Schuurmans, Maarten Bosma, Ed Chi, Quoc Le, and Denny Zhou. [[2201.11903|Chain-of-Thought Prompting Elicits Reasoning in Large Language Models]]. ArXiv, 2022. 3, 7
...
Jacob Andreas, Marcus Rohrbach, Trevor Darrell, and Dan Klein. [[1511.02799|Neural module networks]]. 2016 IEEE Conference on Computer Vision and Pattern Recognition (CVPR), pages 39–48, 2016. 2, 3
